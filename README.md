...
Result data through: `2026-05-20T13:36:45-07:00`.
...
| `2026-05-20T13:36:45-07:00` teacher summary mtime | Guarded blend first-blunder mining (`reports/2026-05-20_guarded_selector_probe.md`). | N/A | N/A | The new gate's first confirmed mistakes were `Re1` instead of `Na3` in game 1 and `...Nxa2+` instead of `...Rf8` in game 2, producing a 14-position diagnostic slice. |
