...
The same context checkpoint also failed at `64` simulations, so simply spending
more visits under the current value/policy heads is not enough for these lines.
