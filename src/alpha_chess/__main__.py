...
def main(argv: list[str] | None = None) -> None:
    ...
    train_parser.add_argument("--holdout-data", nargs="+")
    ...
    train_parser.add_argument("--bad-action-delta-weight", type=float, default=0.0)
    train_parser.add_argument(
        "--bad-action-loss-type",
        choices=("margin", "probability"),
        default="margin",
    )
    ...
    train_parser.add_argument("--distill-checkpoint")
    train_parser.add_argument("--distill-data", nargs="+")
    train_parser.add_argument("--distill-batch-size", type=int)
    train_parser.add_argument("--policy-distill-weight", type=float, default=0.0)
    train_parser.add_argument("--distill-temperature", type=float, default=1.0)
    ...
    validate_parser.add_argument("--bad-action-delta-weight", type=float, default=0.0)
    ...
    teacher_parser.add_argument("--pgn", nargs="+")
    teacher_parser.add_argument("--fen-file", nargs="+")
    ...
    teacher_parser.add_argument("--skip-positions", type=int, default=0)
    ...
    iterate_parser.add_argument("--select-best-by")
    ...
    iterate_parser.add_argument("--self-play-policy-weight", type=float, default=1.0)
    iterate_parser.add_argument("--replay-policy-weights", type=float, nargs="+")
